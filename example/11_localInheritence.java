...
class Top {
	...
	// static class/package camouflage
	void m3() {
		class Local4 extends javax.swing.JButton {
			void ppp() {
				// omp parallel
				{
					int tmp = bububu;
	...
	// non-static class/package camouflage
	// void m4() {
	// 	notjava java = new notjava();
	// 	class Local5 extends java.awt.geom.Area {
	// 		void rrr() {
	// 			// omp parallel
	// 			{
	// 				int tmp = trololo;
